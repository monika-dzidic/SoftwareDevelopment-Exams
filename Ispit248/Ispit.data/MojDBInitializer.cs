...
namespace Ispit.data
{
    ...
    {
        public static void Izvrsi(MyContext context)
        {
        ...
        public static void DodajPonudu(Klijent klijent, DateTime dateTime, MyContext context)
        {
       ...
       public static List<Proizvod> proizvodi = new List<Proizvod>();
        public static void DodajProizvod(string proizvod, float cijena, AkcijskiKatalog akcijskiKatalog, float katalogPopust, MyContext context)
        {
            var p = new Proizvod
            {
                Naziv = proizvod,
