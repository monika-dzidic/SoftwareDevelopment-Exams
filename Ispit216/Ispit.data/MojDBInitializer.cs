...
namespace Ispit.data
{
    public static class MojDBInitializer
    {
        ...
        private static void DodajOdjeljenja(MyContext context, int odjeljenje, Nastavnik nastavnik1)
        {
        ...
        private static void DodajUpis(MyContext context, Odjeljenje odjeljenje)
        {
            int brojUDnevniku = 1;
            for (int i = 0; i < 25; i++)
            {
